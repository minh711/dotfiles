...
- kitty: better terminal than default `gnome-terminal` (more utilities).

- [nautilus-open-any-terminal](https://github.com/Stunkymonkey/nautilus-open-any-terminal): helper to open `kitty` instead of default `gnome-terminal` (may uninstall `gnome-terminal`).
